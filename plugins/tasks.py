...
class Services(IPlugin):
    ...
    def ProcessPlugin(self, hive=None, format=None, format_file=None):
        ...
        for sK in Registry.Registry(self.hive).open("Microsoft\\Windows\\CurrentVersion\\Explorer").subkeys():
            print sK.name()
        #for vals in Registry.Registry(self.hive).open("Microsoft\\Windows\\CurrentVersion\\Explorer\\SharedTaskScheduler").values():
        #    print vals
